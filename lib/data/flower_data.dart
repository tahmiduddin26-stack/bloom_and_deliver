...
final List<Flower> allFlowers = [
  ...
  Flower(
    ...
    vibes: [VibeTag.romantic, VibeTag.elegant],
    cost: 8,
    wiltsAfterDays: 4,
    unlockDay: 1,
  ),
  ...
  Flower(
    ...
    vibes: [VibeTag.sympathy, VibeTag.elegant, VibeTag.delicate],
    cost: 6,
    wiltsAfterDays: 3,
    unlockDay: 1,
  ),
  ...
  Flower(
    ...
    vibes: [VibeTag.cozy, VibeTag.fresh, VibeTag.delicate],
    cost: 4,
    wiltsAfterDays: 6,
    unlockDay: 1,
    seedPrice: 2,
  ...
  Flower(
    ...
    vibes: [VibeTag.sympathy, VibeTag.cozy],
    cost: 4,
    wiltsAfterDays: 5,
    unlockDay: 1,
  ),
  ...
  Flower(
    ...
    vibes: [VibeTag.delicate, VibeTag.fresh, VibeTag.romantic],
    cost: 2,
    wiltsAfterDays: 4,
    unlockDay: 1,
    isFiller: true,
