...
const List<LevelDef> allLevels = [
  ...
  LevelDef(
    ...
    subtitle: 'Grow your own blooms',
    emoji: '🪴',
    star2Earnings: 320,
    star3Earnings: 425,
    unlockText: 'Plant seeds on the windowsill and harvest for free.',
  ),
  LevelDef(
    number: 10,
    title: 'Rare Beauty',
  ...
  LevelDef(
    ...
    subtitle: 'Deliveries after closing time',
    emoji: '🚲',
    star2Earnings: 345,
    star3Earnings: 460,
    unlockText: 'Evening delivery missions pay extra.',
  ),
  LevelDef(
    number: 12,
  ...
  LevelDef(
    number: 14,
    title: 'The Big Commission',
    subtitle: 'A three-day wedding order',
    emoji: '💒',
    star2Earnings: 375,
    star3Earnings: 500,
    unlockText: 'Multi-day commissions pay a huge completion bonus.',
  ),
  LevelDef(
    number: 15,
    title: 'Full Bloom',
  ...
  LevelDef(
    number: 16,
    title: 'Wholesale Wisdom',
    subtitle: 'Buy in bulk, save big',
    emoji: '📦',
    star2Earnings: 445,
    star3Earnings: 595,
    unlockText: 'Wholesale orders arrive next morning at a discount.',
  ),
  LevelDef(
    number: 17,
    title: 'Festival Eve',
...
LevelDef levelForDay(int day) {
  ...
  return LevelDef(
    ...
    emoji: '🌼',
    star2Earnings: 525 + (day - 20) * 10,
    star3Earnings: 700 + (day - 20) * 15,
